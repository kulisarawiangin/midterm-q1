...
async function main() {
    ...
    // Retrieves the data from the advertise microservice.
    const advertiseResponse = await axios.get("http://advertise/ads");

    // Renders the ads for display in the browser.
    res.render("advertise", { videos: advertiseResponse.data });
});
